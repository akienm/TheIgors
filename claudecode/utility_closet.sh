...
#
# Usage:
#   bash claudecode/utility_closet.sh              — full setup + launch
#   bash claudecode/utility_closet.sh --dry-run    — check only, no changes
#   bash claudecode/utility_closet.sh --no-launch  — setup only, skip tmux
...
INSTALL_SCRIPT="$REPO_ROOT/claudecode/install_igor_linux.sh"
