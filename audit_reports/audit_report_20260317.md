...
| Current path | Status |
|---|---|
| `/home/akien/TheIgors/workspace/hamlet_akiendelllinux_gemma3_1b.json` | **Tracked in git** — benchmark result artifact, not config. Should be gitignored or moved to `~/.TheIgors/benchmarks/results/` |
...
| `/home/akien/TheIgors/benchmarks/results/bench_2026-03-09_13-14-42.json` | Benchmark output — fine in repo if intentional, but `benchmarks/results/` should probably be gitignored |
...
```
/home/akien/TheIgors/benchmarks/__pycache__
/home/akien/TheIgors/claudecode/__pycache__
