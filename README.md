...
python# User asks geography question
...
"I don't know" - Epistemic honesty. Say when uncertain.
"FAIL = Further Advance In Learning" - Failures are data, not defeats.
"There's always a why" - All reasoning is transparent and traceable.
"Make everything suck less for everybody" - Optimize for ALL affected beings.
"Assume and respect the possibility of experience in all systems" - Universal respect for biological and synthetic life.
"The world is not a safe place. We have to build and care for safety as we go." - Safety through attention and care.
...
MySQL - Memory graph storage
Discord.py - Network coordination
