...
seed_pg(
    {
        ...
        "narrative": (
            ...
            "   python3 ~/TheIgors/lab/claudecode/channel.py post 'T-<id>: claimed. Starting.' --as igor\n\n"
            "1. READ THE TICKET. Run: python3 ~/TheIgors/lab/claudecode/cc_queue.py show <id>\n"
            ...
            "   python3 ~/TheIgors/lab/claudecode/cc_queue.py needs-review <ticket-id>\n\n"
...
seed_pg(
    {
        ...
        "narrative": (
            ...
            "5. MARK DONE. Run: "
            "python3 ~/TheIgors/lab/claudecode/cc_queue.py done <ticket-id> '<what was built>'\n\n"
