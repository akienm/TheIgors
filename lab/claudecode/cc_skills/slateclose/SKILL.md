...
D304: Slates are daily dated files at `~/.TheIgors/lab/claudecode/YYYYMMDD.slate.txt`.
...
The dated file at `~/.TheIgors/lab/claudecode/$(date +%Y%m%d).slate.txt` is the record.
