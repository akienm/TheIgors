...
```bash
export CLAUDE_MCP_SERVERS="cc_mcp_server:/home/akien/TheIgors/lab/claudecode/cc_mcp_server.py"
```
...
```json
{
  "mcpServers": {
    "cc_mcp": {
      "command": "python3",
      "args": ["/home/akien/TheIgors/lab/claudecode/cc_mcp_server.py"],
      "env": {
...
CLAUDE_TMUX_SESSION=claude-main python3 /home/akien/TheIgors/lab/claudecode/cc_mcp_server.py &
...
CLAUDE_TMUX_SESSION=claude-main python3 ~/TheIgors/lab/claudecode/cc_mcp_server.py &
MCP_PID=$!
...
(
  ...
  sleep 0.1
) | python3 ~/TheIgors/lab/claudecode/cc_mcp_server.py | python3 -m json.tool
