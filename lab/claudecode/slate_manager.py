...
def _today_slate_path() -> Path:
    """Return today's dated slate file path: ~/.TheIgors/lab/claudecode/YYYYMMDD.slate.txt"""
...
def cmd_render():
    ...
    lines += [
        ...
        "",
        "## Design thread",
        "D304: Slates = daily files at ~/.TheIgors/lab/claudecode/YYYYMMDD.slate.txt. Epics = category tags on tickets.",
