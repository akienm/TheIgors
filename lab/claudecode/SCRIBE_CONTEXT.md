...
1. Read this file
2. Run: `python3 ~/TheIgors/lab/claudecode/cc_queue.py list`
...
- Design docs: `~/TheIgors/lab/design_docs/`, `~/TheIgors/lab/design_docs_for_igor/`
- Memory files: `~/.claude/projects/-home-akien-TheIgors/memory/`
- Igor cc_notebook flush: `python3 ~/TheIgors/lab/claudecode/cc_queue.py flush_decision <id> <summary>`
