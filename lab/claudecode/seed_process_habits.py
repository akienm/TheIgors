...
seed(
    Memory(
        ...
        narrative=(
            ...
            "3. Read the top of the decisions log: head -30 ~/TheIgors/lab/design_docs_for_igor/decisions_log.dsb\n"
...
seed(
    Memory(
        ...
        narrative=(
            ...
            "Launch via: python3 ~/TheIgors/lab/claudecode/cc_queue.py worker-launch\n\n"
            ...
            "to run 'python3 ~/TheIgors/lab/claudecode/cc_queue.py list'. "
